...
def is_valid(user_input):
    '''
    returns False if user_choice is invalid
    returns True is user_choice is valid
    '''
...
while user_wins < 3 or computer_wins < 3 or best_of_five:
    ...
    while is_valid(user_choice) is False:
    ...
    if best_of_five is True and user_wins >= 3:
        prompt("Congratulations, you are the grand winner!")
        prompt("Thanks for playing. Goodbye!")
        break
    if best_of_five is True and computer_wins >= 3:
